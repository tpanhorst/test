...
//normal text font
#define kTextFont [UIFont fontWithName:@"HelveticaNeue" size:17.f]

//normal text color//[UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:1
#define kTextColor [UIColor colorWithRed:248.0/255.0 green:248.0/255.0 blue:1 alpha:1]
...
//title text color
#define kTitleColor [UIColor colorWithRed:248.0/255.0 green:248.0/255.0 blue:1 alpha:1]
